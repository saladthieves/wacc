...
TEST_F(PreprocessorTest, throwOnNonExistentFile) {
    // ARRANGE
    const auto args = DriverArgs{
        false, false, false, false, false, false, "test/test_sample/invalid.c"};
    string error{};
...
TEST_F(PreprocessorTest, throwOnInvalidExtension) {
    // ARRANGE
    const auto args =
        DriverArgs{false, false, false, false, false, false, rootFolder};
    string error{};
...
TEST_F(PreprocessorTest, throwOnInvalidCompiler) {
    // ARRANGE
    const auto args =
        DriverArgs{false, false, false,        false,
                   false, false, sampleSource, "unknown-compiler"};
    string error{};
...
TEST_F(PreprocessorTest, runPreprocessorGcc) {
    // ARRANGE
    const auto args = DriverArgs{false, false, false,        false,
...
TEST_F(PreprocessorTest, runPreprocessorClang) {
    // ARRANGE
    const auto args = DriverArgs{false, false, false,        false,
                                 false, false, sampleSource, "clang"};
    string error{};
    string outputFile{};
